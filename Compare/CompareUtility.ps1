...
if((Test-Path $path1 -PathType Container) -and (Test-Path $path2 -PathType Container))
{
...
else
{
    ...
    if(-not (Test-Path $path2 -PathType Container))
    {
        Write-Host "$path2 is not a directory." -ForegroundColor Red
    }
}
